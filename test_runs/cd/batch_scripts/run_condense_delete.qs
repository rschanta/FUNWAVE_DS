...
#SBATCH --dependency=29918668
#SBATCH --output=/lustre/scratch/rschanta/test_runs/cd/logs/run_condense_delete/out/out%a.out
#SBATCH --error=/lustre/scratch/rschanta/test_runs/cd/logs/run_condense_delete/err/err%a.out
#
    ...
    python "/work/thsu/rschanta/RTS-PY/test_runs/cd/pipe/pro.py"
