...
#SBATCH --dependency=28312965
#SBATCH --output=/work/thsu/rschanta/RTS-PY/fw_models/D3Pi/logs/T1/run_condense_outputs/out/out%a.out
#SBATCH --error=/work/thsu/rschanta/RTS-PY/fw_models/D3Pi/logs/T1/run_condense_outputs/err/err%a.out
#

    . /opt/shared/slurm/templates/libexec/openmpi.sh
    ## Construct name of file
        input_dir="/lustre/scratch/rschanta/D3Pi/T1/inputs/"
    ...
    python "/work/thsu/rschanta/RTS-PY/fw_models/D3Pi/model_pipelines/T1/p02_run_condense.py"
