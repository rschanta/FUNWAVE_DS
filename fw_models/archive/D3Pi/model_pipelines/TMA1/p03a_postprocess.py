...
paths = [f'/work/thsu/rschanta/DATA/D3Pi/TMA1/fw_outputs/Out_{tri_num:05}.tfrecord']
...
## Save out 
ftf.save_tfrecord2(feature_dict_ML,f'/work/thsu/rschanta/DATA/D3Pi/TMA1/ML_inputs/MLin_{tri_num:05}.tfrecord')
