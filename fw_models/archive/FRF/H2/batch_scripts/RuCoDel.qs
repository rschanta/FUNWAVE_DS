...
#SBATCH --export=ALL
#SBATCH --array=10004-13929
#SBATCH --job-name=RuCoDel3
#SBATCH --output=/work/thsu/rschanta/RTS-PY/fw_models/FRF/H2/logs/RuCoDel/out/out%a.out
#SBATCH --error=/work/thsu/rschanta/RTS-PY/fw_models/FRF/H2/logs/RuCoDel/err/err%a.out
#
