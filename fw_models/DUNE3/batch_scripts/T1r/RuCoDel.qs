...
#SBATCH --dependency=28637090
#SBATCH --output=/work/thsu/rschanta/RTS-PY/fw_models/DUNE3/logs/T1r/RuCoDel/out/out%a.out
#SBATCH --error=/work/thsu/rschanta/RTS-PY/fw_models/DUNE3/logs/T1r/RuCoDel/err/err%a.out
#
    ...
    python "/work/thsu/rschanta/RTS-PY/fw_models/DUNE3/model_pipelines/T1r/cond_T1r.py"
