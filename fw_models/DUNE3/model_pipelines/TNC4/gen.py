...
import nc_code2 as mod         # Model specific code

# Define the design matrix
matrix_file = '/work/thsu/rschanta/RTS-PY/fw_models/DUNE3/design_matrices/TNC4.csv'
...
# Plot functions
plot_functions = [fs.plot_1D_bathy_nc2,
                  fs.plot_TS_spectra_nc2]

# Filter functions
filter_functions = []

# Print functions
print_functions = [fs.print_bathy_nc3,
                   fs.print_TS_spectra_nc2]
