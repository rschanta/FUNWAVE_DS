...
#SBATCH --dependency=29660928
#SBATCH --output=/work/thsu/rschanta/RTS-PY/fw_models/USACE_Empty_Tank/A1/logs/run_condense_delete/out/out%a.out
#SBATCH --error=/work/thsu/rschanta/RTS-PY/fw_models/USACE_Empty_Tank/A1/logs/run_condense_delete/err/err%a.out
#
