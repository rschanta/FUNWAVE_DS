...
#SBATCH --dependency=29661356
#SBATCH --output=/work/thsu/rschanta/RTS-PY/fw_models/USACE_Empty_Tank/A2/logs/run_condense_delete/out/out%a.out
#SBATCH --error=/work/thsu/rschanta/RTS-PY/fw_models/USACE_Empty_Tank/A2/logs/run_condense_delete/err/err%a.out
#
    ...
    python "/work/thsu/rschanta/RTS-PY/fw_models/USACE_Empty_Tank/A2/model_pipelines/pro.py"
