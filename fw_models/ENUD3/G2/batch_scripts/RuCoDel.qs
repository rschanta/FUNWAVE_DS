...
#SBATCH --export=ALL
#SBATCH --array=1500-2000
#SBATCH --job-name=RuCoDel
#SBATCH --output=/work/thsu/rschanta/RTS-PY/fw_models/ENUD3/G2/logs/RuCoDel/out/out%a.out
#SBATCH --error=/work/thsu/rschanta/RTS-PY/fw_models/ENUD3/G2/logs/RuCoDel/err/err%a.out
#
