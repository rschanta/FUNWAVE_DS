...
paths = [f'/work/thsu/rschanta/DATA/DFR_Pi/TMA2/fw_outputs/Out_{tri_num:05}.tfrecord']
...
## Save out 
ftf.save_tfrecord2(feature_dict_ML,f'/work/thsu/rschanta/DATA/DFR_Pi/TMA2/ML_inputs/MLin_{tri_num:05}.tfrecord')
