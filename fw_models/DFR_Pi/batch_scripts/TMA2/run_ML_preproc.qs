...
#SBATCH --export=ALL
#SBATCH --job-name=run_ML_preproc
#SBATCH --output=/work/thsu/rschanta/RTS-PY/fw_models/DFR_Pi/logs/TMA2/run_ML_preproc/out.out
#SBATCH --error=/work/thsu/rschanta/RTS-PY/fw_models/DFR_Pi/logs/TMA2/run_ML_preproc/err.out
#
