...
#SBATCH --export=ALL
#SBATCH --array=2401-3200
#SBATCH --job-name=RuCoDel
#SBATCH --output=/work/thsu/rschanta/RTS-PY/fw_models/IRR/D1/logs/RuCoDel/out/out%a.out
#SBATCH --error=/work/thsu/rschanta/RTS-PY/fw_models/IRR/D1/logs/RuCoDel/err/err%a.out
#
    ...
    python "/work/thsu/rschanta/RTS-PY/fw_models/IRR/D1/model_pipelines/pro.py"
