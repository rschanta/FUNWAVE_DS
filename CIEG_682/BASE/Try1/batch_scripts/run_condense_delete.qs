...
#SBATCH --dependency=29816447
#SBATCH --output=/work/thsu/rschanta/RTS-PY/CIEG_682/BASE/Try1/logs/run_condense_delete/out/out%a.out
#SBATCH --error=/work/thsu/rschanta/RTS-PY/CIEG_682/BASE/Try1/logs/run_condense_delete/err/err%a.out
#
    ...
    python "RTS-PY/CIEG_682/BASE/Try1/model_pipelines/pro.py"
