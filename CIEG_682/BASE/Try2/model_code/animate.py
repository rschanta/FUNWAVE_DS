...
def animate_eta(ds,
    ...
    out = cv2.VideoWriter(save_to_mp4, fourcc, fr, (width, height))
    ...
    for t_i in range(0, len(t), stride):
        ...
        ax.axvline(Xc_WK,
               label=f'WK: a = {AMP_WK:.2f} m, T = {Tperiod:.2f} s, $\theta$ = {Theta_WK:.1f}',
