...
def generate_files(file=None):
    ...
    python "RTS-PY/runs/dep_flat_reg/model_pipelines/matrix_1/{file}" {super_path} {run_name}
    """
    return text_content
...
def run_files(file=None,FW_ex=None):
    ...
    ## COMPRESS
    conda activate {env_name}
    python "RTS-PY/runs/dep_flat_reg/model_pipelines/matrix_1/{file}" {super_path} {run_name} $SLURM_ARRAY_TASK_ID
