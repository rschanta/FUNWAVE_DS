...
def main(super_path, run_name,tri_num):
    ...
    # TODO: functionize this block (ie- look for the tensors and get them into the dictionary)

    # <<<
    # Condense the inputs/output arrays
    # Can specify inputs, or just assume all
    # Can specify outputs, or assume all (check if ETA = )
    def condense_serialize_io(var_list,tri_num)
        # Load in In_d

        # Add In_d to the dictionary
        
        # Get the var_paths in out_XXXXX
    ...
    def condense_serialize_inputs(var_list,tri_num):


    ## Other things that can be serialized
    ...
    # TODO: functionize this block (ie- get everything in In_d and add to dictionary)
    In_d = fp.tf.load_In_d(f'{super_path}/{run_name}/inputs-proc/In_d.pkl')
    
    
    # TODO: Functioize this: serialization by feature
    # <<<<
