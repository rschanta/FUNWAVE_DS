...
#SBATCH --dependency=29921978
#SBATCH --output=/lustre/scratch/rschanta/USACE/Flat_Tank/Base_Study/logs/run_condense_delete/out/out%a.out
#SBATCH --error=/lustre/scratch/rschanta/USACE/Flat_Tank/Base_Study/logs/run_condense_delete/err/err%a.out
#
    ...
    python "/work/thsu/rschanta/RTS-PY/USACE/Flat_Tank/Base_Study/pipe/pro.py"
